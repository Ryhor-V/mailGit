...
public class LoginPage extends AbstractPage {
	...
	public void fillLogin(String username) {
		...
		inputLogin = driver
				.findElement(By.xpath("*//div[@class='login-row username']/descendant::input[@class='c0146']"));
		inputLogin.clear();
	...
	public void fillPass(String password) {
		inputPassword = driver
				.findElement(By.xpath("*//div[@class='login-row password']/descendant::input[@class='c0146']"));
		inputPassword.clear();
