...
public class SendingMail extends AbstractPage {
	private final String BASE_URL = "https://e.mail.ru/login";
	...
	public void openPage() {
		...
		System.out.println("Write Hello page opened");

	}
	
	public void sendLetter(String em, String top, String message) {
		WebElement e_mail = driver.switchTo().activeElement();
		e_mail.clear();
		e_mail.sendKeys(em);
		e_mail.sendKeys(Keys.TAB);
		e_mail.sendKeys(top);
